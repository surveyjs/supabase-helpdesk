...
- **Left side**: App name "HelpDesk" (links to home), "My Tickets" link, "Help Center" link, (for agents) "Agent Dashboard" link, (for agents) "Manage Articles" link, (for admins only) "Reports" link, and (for admins only) "Setup" link.
